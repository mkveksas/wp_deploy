...
require( get_template_directory() . '/admin/post-type-portfolio.php' );
require( get_template_directory() . '/admin/post-type-team.php' );
require( get_template_directory() . '/admin/post-type-client.php' );
...
//require( get_template_directory() . '/admin/post-type-location.php' );
...
function pwd_setup() {
	...
	add_image_size('grid', 640, 640, true );
...
function pwd_widgets_and_sidebars_init() {
	...
	register_sidebar( array(
		'name' => __( 'Sidebar Lacation Pages', 'pwd' ),
		'id' => 'sidebar-location',
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
 ...
 */
	...
	wp_enqueue_style( 'animate', get_template_directory_uri() . '/lib/WOW/css/libs/animate.css' );

	wp_enqueue_style( 'style-bxslider', get_template_directory_uri() . '/lib/jquery.bxslider/jquery.bxslider.min.css');
	wp_enqueue_style( 'style-fancybox', get_template_directory_uri() . '/lib/jquery.fancybox/jquery.fancybox.min.css' );

	wp_enqueue_style( 'style-jquery-ui', get_template_directory_uri() . '/style-jquery-ui.min.css' );
	
	//wp_enqueue_style( 'style', get_template_directory_uri() . '/style.original.css' );
	wp_enqueue_style( 'style', get_stylesheet_uri() );

	wp_enqueue_style( 'style-responsive', get_template_directory_uri() . '/style-responsive.min.css' );

	wp_enqueue_script( 'jquery-bxslider', get_template_directory_uri() . '/lib/jquery.bxslider/jquery.bxslider.min.js', array( 'jquery' ), '4', true );
	wp_enqueue_script( 'jquery-fancybox', get_template_directory_uri() . '/lib/jquery.fancybox/jquery.fancybox.pack.js', array( 'jquery' ), '1.3.4', true );

	wp_enqueue_style( 'pace', get_template_directory_uri() . '/lib/pace/themes/pace-theme-flat-top.css' );
	wp_enqueue_script( 'pace', get_template_directory_uri() . '/lib/pace/pace.min.js', array( 'jquery' ), '0.5.7', true);

	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/lib/bootstrap/js/bootstrap.min.js', array( 'jquery' ), '1.3.4', true  );
	wp_enqueue_script( 'rspond', get_template_directory_uri() . '/lib/rspond/respond.min.js', array( 'jquery' ), '1', true  );

	wp_enqueue_script( 'imagesloaded', get_template_directory_uri() . '/js/imagesloaded.pkgd.min.js', array( 'jquery' ), '1.3.4', true  );
	wp_enqueue_script( 'mixitup', get_template_directory_uri() . '/lib/mixitup/jquery.mixitup.min.js', array( 'jquery' ), '1', true  );

	//wp_enqueue_style( 'style-scrollUp', get_template_directory_uri() . '/lib/scrollup/css/themes/link.css' );
	wp_enqueue_script( 'scrollUp', get_template_directory_uri() . '/lib/scrollup/jquery.scrollUp.min.js', array( 'jquery' ), '1', true  );

	wp_enqueue_script( 'jquery-sticky', get_template_directory_uri() . '/lib/sticky/jquery.sticky.min.js', array( 'jquery' ), '0.5.7', true);
	...
	wp_enqueue_script( 'pwd-custom', get_template_directory_uri() . '/js/pwd-custom.min.js', array( 'jquery' ), '1.0', true );
...
add_filter( 'gform_submit_button', 'pwd_form_submit_button', 10, 2 );
function pwd_form_submit_button( $button, $form ) {

	return "<button class='btn btn-primary gform_button button' id='gform_submit_button_{$form['id']}'><span>{$form['button']['text']}</span></button>";
}
...
add_action('wp_ajax_grecaptcha_check', 'grecaptcha_check');
add_action('wp_ajax_nopriv_grecaptcha_check', 'grecaptcha_check');
