...
function pwd_posted_on() {
	printf( __( '<span class="posted-on">Posted on</span> <a class="post-date" href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s">%4$s</time></a><span class="byline"> by <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author" itemprop="author">%7$s</a></span></span>', 'pwd' ),
