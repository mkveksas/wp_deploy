<div id="service-carousel" class="page-section">
	<div class="container-fluid">
		<div class="row">

			<div class="item-carousel service-carouse">
				<?php
				$args = array(
					'post_type' 		=> 'service',
					'orderby' 			=> 'menu_order',
				...
				<div class="col-md-3 col-sm-3 nopadding">
					<div class="item post-grid">
						...
						<h2 class="item-title"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute( 'echo=0' ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>      
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function($) {
			$('#service-carousel .item-carousel').bxSlider({
				minSlides: 1,
				maxSlides: 4,
				slideWidth: 500,
				slideMargin: 0,
