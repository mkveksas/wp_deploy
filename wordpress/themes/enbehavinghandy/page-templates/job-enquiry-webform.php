...
/**
 * Template Name: Job Enquiry Webform
 *
			...
			<div class="col-md-12">
				<div id="content" role="main">
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<form id="frmjob" accept-charset="UTF-8" action="https://uz264.infusionsoft.com/app/form/process/240f5f3a7607b69ad8d44ad21aef5daf" class="infusion-form" method="POST">
							...
							<div class="infusion-field row">
								...
								<div class="col-md col-md-9">
									<select class="large" id="inf_custom_Jobtobedone" name="inf_custom_Jobtobedone"><option value="">Please select one</option><option value="ASAP">ASAP</option><option value="Within 1 week">Within 1 week</option><option value="Within 1 month">Within 1 month</option><?php/*?><option value="In the future">In the future</option><?php*/?></select>
								</div>
							</div>
							<div class="infusion-field row">
